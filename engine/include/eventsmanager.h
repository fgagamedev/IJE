...
public:
    ...
    void register_mouse_button_event_listener(MouseButtonEventListener *listener);
    ...
    void unregister_mouse_button_event_listener(MouseButtonEventListener *listener);
